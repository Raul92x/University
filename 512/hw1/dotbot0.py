...
class DotBot:
	...
	def sensor(self,wall):
		...
		if ((self.location.x, self.location.y-GRID) in wall) or ((self.location.x+GRID, self.location.y-GRID) in wall):
			x1 = 1
		if ((self.location.x+GRID, self.location.y) in wall) or ((self.location.x+GRID, self.location.y+GRID) in wall):
			x2 = 1
		if ((self.location.x, self.location.y+GRID) in wall) or ((self.location.x-GRID, self.location.y+GRID) in wall):
			x3 = 1
		if ((self.location.x-GRID, self.location.y) in wall) or ((self.location.x-GRID, self.location.y-GRID) in wall):
