...
;Description: IN THIS PROGRAM WE GENERATE RANDOM
;NUMBERS USING A LINEAR CONGRUENTIAL RANDOM NUMBER
;GENERATOR (LCRNG). AN INTEGER IN THE RANGE 1 TO
;32766 IS FOUND AT LOCATION x3100 AND WHEN THE
;PROGRAM IS EXECUTED, 20 RANDOM NUMBERS IN THE 
;INTERVAL 1 TO (2^15) -2 ARE GENERATED AND 
;DISPLAYED
